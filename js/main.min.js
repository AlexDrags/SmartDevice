...
/* harmony import */ var _utils_click_handlers__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils/click-handlers */ "./js/utils/click-handlers.js");
...
/* harmony import */ var _modules_form_utils_form_utils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/form-utils/form-utils */ "./js/modules/form-utils/form-utils.js");
/* harmony import */ var _modules_form_utils_form_utils__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_modules_form_utils_form_utils__WEBPACK_IMPORTED_MODULE_4__);
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_accordion_accordion__WEBPACK_IMPORTED_MODULE_3__["accordeonInit"])();
    _utils_click_handlers__WEBPACK_IMPORTED_MODULE_2__["handler"].openText();
    _utils_click_handlers__WEBPACK_IMPORTED_MODULE_2__["toScroll"].requestForm();
    // validates.addDisabled();
  });
});
...
/***/ "./js/modules/form-utils/form-utils.js":
/*!*********************************************!*\
  !*** ./js/modules/form-utils/form-utils.js ***!
  \*********************************************/
  ...
  var eventCalllback = function eventCalllback(e) {
    ...
    if (clearVal !== 'false' && e.type === 'blur') {
      if (val.length < matrix.match(/([\_\d])/g).length) {
        e.target.value = 'Заполните поле полностью';
        return;
      }
      e.target.value = '';
    }
...
document.querySelector('.index-header__button').addEventListener('click', function () {
  setTimeout(function () {
...
/***/ "./js/utils/click-handlers.js":
/*!************************************!*\
  !*** ./js/utils/click-handlers.js ***!
  \************************************/
/*! exports provided: toScroll, handler */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "toScroll", function() { return toScroll; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "handler", function() { return handler; });
function MoreText(button, text) {
  this.text = text;
  this.button = button;
}
MoreText.prototype.requestForm = function requestForm() {
  this.button.addEventListener('click', function () {
    document.querySelector('.feedback__wrapper').scrollIntoView({
      block: 'center',
      inline: 'center',
      behavior: 'smooth'
    });
...
MoreText.prototype.openText = function openText() {
  var _this = this;
  this.button.addEventListener('click', function () {
    for (var i = 0; i <= _this.text.length; i++) {
      if (_this.text[i].style.display === 'block') {
        _this.text[i].style.display = 'none';
        _this.button.textContent = 'Подробнее';
      } else {
        if (window.innerWidth <= 767) {
          document.querySelector('.moretext-js--first').style.display = 'none';
        }
        _this.text[i].style.display = 'block';
        _this.button.textContent = 'Свернуть';
      }
    }
  });
};
var toScroll = new MoreText(document.querySelector('.button--request-js'));
var handler = new MoreText(document.querySelector('.button--moretext-js'), document.querySelectorAll('.moretext-js'));
